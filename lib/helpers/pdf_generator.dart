...
class PdfBuilderApi {
  static Future<File> generateMobile(Invoice invoice) async {
    ...
    return PdfStoreApi.saveDocumentMobile(
        name: 'generated_Invoice.pdf', pdf: pdf);
  }
  ...
  static Future<Uint8List> generateWeb(Invoice invoice) async {
    ...
    return PdfStoreApi.saveDocumentWeb(name: 'generated_Invoice.pdf', pdf: pdf);
  }
  ...
  static Widget buildInvoiceInfo(InvoiceInfo info) {
    ...
    final data = <String>[
      info.number,
      DateFormat('en-GB').format(info.date),
      // info.date.toIso8601String(),
      // DateFormat.yMMMd.formatDate(info.date),
      paymentTerms,
      // Utils.formatDate(info.dueDate),
      // info.dueDate.toIso8601String()
      DateFormat('en-GB').format(info.dueDate),
    ];
  ...
  static Widget buildFooter(Invoice invoice) => Column(
        ...
        children: [
          ...
          SizedBox(height: 1 * PdfPageFormat.mm),
          buildSimpleText(
              title: 'Bank Account', value: invoice.supplier.paymentInfo),
        ],
      );
